...
features_to_scale = ['goal', 'timedelta']
target = 'label'

st.markdown("### Original DF")
st.dataframe(clean_raw_ks_df(load_ks_data()).head())
feature_df = (
    load_ks_data()
...
st.markdown(f"## chosen scaler: robust") # ["normalization", "standardization", "robust"]:
